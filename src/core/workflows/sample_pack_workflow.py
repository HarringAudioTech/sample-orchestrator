...
class SamplePackWorkflow:
    ...
    def process_recording(
        ...
        try:
            ...
            classified = self.segment_classification.process(
                segments, params.get("segment_classification", {}), context
            )
