...
if __name__ == "__main__":
    ...
    example_chain = [
        ...
        {"stage_name": "reverb_effect", "params": {"mix": 0.7}},  # Override default
    ...
    try:
        if not STAGE_REGISTRY:
            logger.warning(
                "STAGE_REGISTRY is empty. Example stages might not have been registered if run directly without full package context or if AudioProcessingStage was not fully defined."
            )
        else:
