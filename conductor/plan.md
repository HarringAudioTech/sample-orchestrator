...
- [ ] Task: Refine `onset_detection` parameters for drum hits.
    - [ ] Adjust FFT and hop length for sharper transient detection.
    - [ ] Implement zero-crossing snapping for all slice points.
- [ ] Task: Implement transient-preserving micro-fades for all slices.
